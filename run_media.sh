...
docker run -it --rm --privileged --net=host -e DISPLAY=$DISPLAY -v $HOME:/home openvino-apt /usr/share/mfx/samples/sample_decode h264 -i /home/big_buck_bunny_1080p_h264.264 -r -rgb4
